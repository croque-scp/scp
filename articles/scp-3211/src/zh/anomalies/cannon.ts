...
export default new Anomaly(false, {
  ...
  objectClass: "Safe",
  physicalDescription: `
    SCP-3211是一个未知的物件、实体或概念。

    在进入收容室之后，所有的观察者都会立即相信该室之前收容有一门半重型军用火炮，由钢铁及1575年的法国橡木制成，并于福兹沃斯战役中使用，后在大英博物馆保存至今。观察人员会认为这是完全正常的并恢复正常工作，这可能会导致其反复进出收容室（这也被认为是正常的）。这些行为以及虚假记忆都只有当观察者注意到或被告知，福兹沃斯战役并不存在而且SCP-3211是在Site-21而不是在大英博物馆，之后才会意识到为异常。
  `,
